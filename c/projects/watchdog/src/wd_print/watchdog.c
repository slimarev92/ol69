...
static long CheckPong(void *args)
{
	static int seconds_til_revive = RESET_REVIVE_TIME;
	...
	{
		printf("%sWatchdog: %d tries left.\n", YELLOW, seconds_til_revive);
		--seconds_til_revive;
	}
	else
	{
		...
		seconds_til_revive = RESET_REVIVE_TIME;
	}
...
int main(int argc, char **argv)
{
	...
	printf("%sWatchdog: is up!\n", YELLOW);
	RunWD(argv);
	printf("%sWatchdog: about to exit.\n", YELLOW);
