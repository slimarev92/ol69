...
import il.co.ilrd.concurrency.WaitableQueueConditionVariable;

public class WaitableQueueCVTest {

	@Test
	public void testSimple() throws InterruptedException {
		WaitableQueue<Integer> queue = new WaitableQueueConditionVariable<>();
	...
	public void testSimpleComparator()  throws InterruptedException {
		...
		WaitableQueue<Integer> queue = new WaitableQueueConditionVariable<>((num1, num2) -> num2 - num1);
